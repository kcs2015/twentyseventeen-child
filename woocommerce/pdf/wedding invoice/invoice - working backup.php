...
$rsv_info_initial_deposit_val = intval($payment_arr[1]);
...
foreach($curr_order_meta as $meta_arr_val):
    if(strpos($meta_arr_val->key,"payment_") !== FALSE):
        ...
        $total_payments_made += intval($payment_arr[1]);
                ...
                <table class="invoice-large-info-table">
                    ...
                    if (!empty($initial_payment_arr)): ?>
                        <tr class="bg-color-secondary">
                            ...
                            <td>$<?php echo(number_format (floatval($initial_payment_arr[1]))); ?>  </td>
                        </tr>
                    <?php endif;
                    ...
                    foreach( $rsv_info_payment_arr as $payment_num=> $payment_amt ):
                        ...
                        <tr class="bg-color-secondary">
                            ...
                            <td>$<?php echo(number_format (floatval($rsv_payment_arr[1]))); ?>  </td>
                        </tr>
                    <?php   endforeach;
                    ...
                    while ($invoice_start_num < count($invoice_due_date_arr)): ?>
                        <tr><td><?php echo($invoice_due_date_arr[$invoice_start_num]); ?></td>
                            <td>$<?php echo (number_format (floatval($remaining_payments))); ?></td>
                        </tr>
            ...
            <td>
                <table id="travel-details-tbl" class="invoice-large-info-table float-right">
                    ...
                    <tr><td>Resort
                        ...
                        <td>$ <?php echo(number_format (floatval($rsv_info_invoice_total))) ?></td>
                    </tr>
                    </tbody>
                </table>
            ...
            <td>
                <table id="invoice-balance-tbl" class="invoice-large-info-table">
                    <tr><td>Current Balance</td>
                        <td>$<?php echo (number_format (floatval( $total_remaining_balance))); ?></td>
                    </tr>
                </table>
            ...
            <td>
                <table class="due-date-info-table float-right">
                    ...
                    <tr><td>Total Due:</td><td>$<?php
                            ...
                            echo(number_format (floatval($current_payment_due))); ?></td></tr>
            ...
            <td>
                <table id="total-package-breakdown-tbl" class="invoice-large-info-table">
                    ...
                    <tr><td>Resort Package Total:</td>
                        <td>$ <?php echo(number_format (floatval($resort_rsv_total))) ?></td>
                    </tr>
                    ...
                    <tr><td><?php echo($air_service_requested_html); ?> Total (For All Included Guests):</td>
                        <td>$
                            <?php if($rsv_info_air_service_requested == "flight"):
                                echo(number_format (floatval($flight_rsv_total)));

                            elseif($rsv_info_air_service_requested == "transfers"):
                                echo(number_format (floatval($airport_transfers_rsv_total)));
                            endif; ?>
                                </td>
                                </tr>
                            <?php else: ?>
            ...
            <td>
                <table id="per-guest-breakdown" class="invoice-large-info-table float-right">
                    ...
                    <tr><td>Resort Rate Per Guest Per Night</td>
                        <td>$<?php echo (number_format (floatval($rsv_info_resort_rate_per_guest_per_night))); ?>
                        </td>
                    </tr><tr><td>Number of Nights</td>
                        <td><?php echo ($resort_num_nights); ?></td>
                    </tr>
                    <tr><td>Resort Total Per Guest</td>
                        <td>$<?php echo (number_format (floatval($rsv_info_resort_total_per_guest))); ?></td>
                    </tr>
                    <?php if($rsv_info_air_service_requested != "none"): ?>
                    <tr><td><?php echo($air_service_requested_html); ?> Total Per Guest</td>
                        <td>$<?php echo (number_format (floatval($rsv_info_air_service_rate_per_guest))); ?></td>
                    </tr>
                    <?php else: ?>
                        <tr>
                    ...
                    <tr><td>Resort <?php if($rsv_info_air_service_requested != "none"): echo(" + " .$air_service_requested_html); endif ?> Total Per Guest</td>
                        <td>$<?php
                            ...
                            echo (number_format (floatval($invoice_total_per_guest))); ?></td>
                    </tr>
                </table>
            </td>
        </tr>
